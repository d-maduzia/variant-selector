...
VariantSelector is a sample e-commerce product page built with Angular 21. It demonstrates a responsive UI for selecting product variants, adjusting quantities, and adding items to a cart.
...
The project emphasizes accessibility, featuring semantic markup and full keyboard navigation. It was used as a demo during the Case Study: Building An Accessible Variant selector talk, showcasing practical approaches to building accessible Angular interfaces.
...
- [ The Only Accessibility Video You Will Ever Need ](https://www.youtube.com/watch?v=2oiBKSjOOFE)  
  An introduction to the topic for those of you that prefer video content.
